...
import OnboardingScreen3Image from "../../assets/onboarding_screen3.png";
      ...
      <VStack space="xl" className="flex-1 justify-between">
        ...
        <View style={styles.topSection}>
          ...
          <Text style={styles.description}>
            Stay updated with class reminders, schedule changes, and important
            announcements.
          </Text>
        </View>

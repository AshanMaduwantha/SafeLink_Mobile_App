...
const buttonStyle = tva({
  base:
    "group/button rounded bg-primary-500 flex-row items-center justify-center " +
  ...
  variants: {
    action: {
      ...
      secondary:
        "bg-secondary-500 border-secondary-300 data-[hover=true]:bg-secondary-600 " +
        "data-[hover=true]:border-secondary-400 data-[active=true]:bg-secondary-700 " +
        "data-[active=true]:border-secondary-700 data-[focus-visible=true]:web:ring-indicator-info",
      positive:
        "bg-success-500 border-success-300 data-[hover=true]:bg-success-600 " +
        "data-[hover=true]:border-success-400 data-[active=true]:bg-success-700 " +
        "data-[active=true]:border-success-500 data-[focus-visible=true]:web:ring-indicator-info",
      negative:
        "bg-error-500 border-error-300 data-[hover=true]:bg-error-600 " +
        "data-[hover=true]:border-error-400 data-[active=true]:bg-error-700 " +
  ...
  return (
    <UIButton.Text
      ...
      className={buttonTextStyle({
        parentVariants: {
          variant: parentVariant,
          size: parentSize as "xs" | "sm" | "md" | "lg" | "xl" | undefined,
          action: parentAction,
        },

...
export const palette = {
  ...
  calpyse: "#2b7488",
  gray500: "#888888",
  gray300: "#d1d5db", // Added gray300
  success: "#10b981", // Added success green
  amber400: "#fbbf24", // Added amber400 for stars
};
...
export const LightTheme: ExtendedTheme = {
  ...
  fonts: {
    regular: { fontFamily: fonts.poppins.regular, fontWeight: "400" },
    medium: { fontFamily: fonts.poppins.regular, fontWeight: "500" },
    bold: { fontFamily: fonts.poppins.regular, fontWeight: "700" },
  },
};
